...
public class Main {
  ...
  public static void characterSelection(){
    ...
    for(int intCount = 0; intCount < strAbilities.length; intCount++){
      ...
      con.drawString(strAbilities[intCount][NAME], 180
                       - (strAbilities[intCount][NAME].length() * 4) + (intCount * 100) +
  ...
  public static String getAbilityActionDesc(int intAbilityId){
    ...
    }else if(strActionType.equalsIgnoreCase("DamageBlock")){
      strReturn += "Stop " + strAbilities[intAbilityId][ACTIONVALUE] + "% damage";
    }else if(strActionType.equalsIgnoreCase("SelfDamage")){
      strReturn += "Attacks (" + strAbilities[intAbilityId][ACTIONVALUE] + "%) will bounce back";
    }
